...
public interface LindaServeur extends Remote {
     ...
     */
    public void eventRegister(eventMode mode, eventTiming timing, Tuple template, RemoteCallback callback) throws java.rmi.RemoteException;
